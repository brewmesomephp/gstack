							...
							<li>
					          	...
					          	<div class="timeline-panel">
                                    ...
                                    <form enctype="multipart/form-data" id="myform">    
                                        ...
                                        <input type="text"  class="form-control input-lg"  name="website" placeholder="Website..."/>
                                        <input type="text"  class="form-control input-lg"  name="skillset" placeholder="Current or Prior Occupation/Skillset..."/>
                                        ...
                                        <textarea name="bio"  class="form-control input-lg"  style="width:100%; height:100px;" placeholder="Short Bio..."/></textarea>
...
$(document).ready(function () { 
        $('body').on('click', '.upload', function(){
            ...
            // Make the ajax call
            $.ajax({
                url: 'process_profile.php?img=true',
                type: 'POST',
                xhr: function() {
...
$(document).ready(function () { 
        $('body').on('click', '.formsubmit', function(){
            ...
            // Make the ajax call
            $.ajax({
                url: 'process_profile.php?img=false',
                type: 'POST',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    if(myXhr.upload){
 ...
 var skill_number = this.id;
    ...
    $(document).ready(function() {
    $('#content_here_please').load('process_profile.php');
    return false;
});
