		...
		<div class="main-content">
                ...
                <!-- start:achievements -->
					        <li id="id-resume">
					        	...
					        	<h1 class="timeline-head">Achievements</h1>
                                    <h5>
					        ...
					        <li>
					          	...
					          	<div class="timeline-panel achievements" id="achievements">
                                    ...
                                    <div class="hr-left"></div>
					          		...
					          		<p>Please fill out the form below</p>
					          			<div class="row">
					          				<div class="col-md-6">
					          					<div class="col-md-12 ">
					          						<input name="title" class="form-control input-lg" placeholder="Achievement Title..."> 
					          					</div>
					          					<div class="col-md-12 ">
				            ...
				            <button type="button" class="btn btn-lg btn-primary btn-success btn-block" id="submit_achievements">SUBMIT</button>
...
//twitter bootstrap script
	$("button#submit_achievements").click(function(){
        
		   	$.ajax({
    		   	type: "POST",
			url: "process_achievements.php",
			data: $('form.achievements').serialize(),
 ...
 var skill_number = this.id;
    ...
    $('#achievements').load('process_achievements.php');
    return false;
});
