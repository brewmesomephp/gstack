...
function getContent($sess_id) 
{
    ...
    $filename = $_SERVER['REQUEST_TIME'] . "-" . $_FILES["fileToUpload"]["name"];
       ...
       $youtube = addslashes($_POST['youtube']);
        ...
        $query = "INSERT INTO `gamerstack`.`company_portfolio` (`id`, `userid`, `title`, `caption`, `description`, `image`, `youtube`, `date_added`) VALUES (NULL, '$sess_id',  '$title', '$caption', '$description', '$image', '$youtube', CURRENT_TIMESTAMP);";
