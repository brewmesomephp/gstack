						...
						<ul class="timeline">
							...
							<li>
					          	...
					          	<div class="timeline-panel">
                                    ...
                                    <h1>Upload Pictures/Screenshots of Your Work</h1>
                                    
                                    <form enctype="multipart/form-data" id="myform">    
                                        <input type="text" name="title" class="form-control input-lg" placeholder="Title..."/> 
                                        <input type="text" name="caption" class="form-control input-lg" placeholder="Caption..."/> <br />
...
<label>Upload your screenshot</label> 
                                        ...
                                        <br>
                                        <input type="button" value="Upload image" class="upload form-control"  />
                                    </form>
...
$(document).ready(function () { 
 ...
 var skill_number = this.id;
    ...
    $(document).ready(function() {
    $('#content_here_please').load('process_upload.php');
    return false;
});
